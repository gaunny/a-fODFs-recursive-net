...
class ComputeSHC(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        """
        # print('self.S2SH',self.S2SH.size())
        # print('x0',x.size())
...
class ShellComputeSignal(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        # print('y',y.size())
        C = x.shape[3]
        # print('self.shellSampling.sampling',self.shellSampling.sampling)
        
        for i, sampling in enumerate(self.shellSampling.sampling):
            # print('i',i)
            # print('self.shellSampling.shell_inverse',self.shellSampling.shell_inverse)
            # print('y',y.size())
            # print('x',x.size())
